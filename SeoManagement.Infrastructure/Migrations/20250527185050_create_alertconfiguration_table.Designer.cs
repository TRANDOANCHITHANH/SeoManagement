...
namespace SeoManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250527185050_create_alertconfiguration_table")]
    partial class create_alertconfiguration_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.AccessStatistics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.ContentOptimizationAnalysis", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AltAttributeIssues")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ContentStructureIssues")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ImageSuggestion")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KeywordDensity")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KeywordUsage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LinkIssues")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MetaSuggestions")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OriginalityCheck")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ReadabilityScore")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("ContentOptimizationAnalyses");
                });
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.RelatedKeyword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CompetitionValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("MonthlySearchVolumesJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("SeedKeywordId")
                        .HasColumnType("int");

                    b.Property<string>("SuggestedKeyword")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.SEOPerformanceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<double?>("AverageKeywordRank")
                        .HasColumnType("float");

                    b.Property<double?>("AverageOnPageScore")
                        .HasColumnType("float");

                    b.Property<int?>("BacklinkCount")
                        .HasColumnType("int");

                    b.Property<int?>("IndexedPageCount")
                        .HasColumnType("int");

                    b.Property<double?>("PageSpeedScore")
                        .HasColumnType("float");
                    ...
                    b.Property<int?>("UnindexedPageCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("SEOPerformanceHistories");
                });
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.SeedKeyword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.UserActionLimit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.ContentOptimizationAnalysis", b =>
                {
                    b.HasOne("SeoManagement.Core.Entities.SEOProject", "Project")
                        .WithMany("ContentOptimizationAnalyses")
                        .HasForeignKey("ProjectID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.RelatedKeyword", b =>
                {
                    b.HasOne("SeoManagement.Core.Entities.SeedKeyword", "SeedKeyword")
                        .WithMany("RelatedKeywords")
                        .HasForeignKey("SeedKeywordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SeedKeyword");
                });
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.SEOPerformanceHistory", b =>
                {
                    b.HasOne("SeoManagement.Core.Entities.SEOProject", "Project")
                        .WithMany("SEOPerformanceHistories")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.SEOProject", b =>
                {
                    ...
                    b.Navigation("SEOPerformanceHistories");

                    b.Navigation("SeedKeywords");
