...
namespace SeoManagement.Infrastructure.Migrations
{
    ...
    [Migration("20250520185121_create_keywordsuggestion_table")]
    partial class create_keywordsuggestion_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.KeywordSuggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.MonthlySearchVolume", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("KeywordSuggestionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KeywordSuggestionId");

                    b.ToTable("MonthlySearchVolumes");
                });
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.MonthlySearchVolume", b =>
                {
                    b.HasOne("SeoManagement.Core.Entities.KeywordSuggestion", "KeywordSuggestion")
                        .WithMany("MonthlySearchVolumes")
                        .HasForeignKey("KeywordSuggestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KeywordSuggestion");
                });
            ...
            modelBuilder.Entity("SeoManagement.Core.Entities.KeywordSuggestion", b =>
                {
                    b.Navigation("MonthlySearchVolumes");
                });
